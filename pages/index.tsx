...
const Home: React.FC<{ historicalWeatherData: HistoricalDaily[]}> = ({ historicalWeatherData }) => {
  return (
    <main className="flex justify-center bg-gray-300 p-3 md:p-5 min-h-screen">
      <div className="w-full max-w-4xl p-5 bg-gray-100 border border-gray-700">
      <h1 className="text-3xl md:text-5xl font-extrabold text-gray-900 mb-3 md:mb-5">Very Simple Brutalist Weather App</h1>
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div className="bg-white p-4 border border-gray-700">
          <CurrentWeather />
        </div>
        <div className="bg-white p-4 border border-gray-700">
